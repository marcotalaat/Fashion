...
<?php if(!isset($_SESSION['Username'])) {  ?>
    ...
    Note: In order to be able to enter Dashboard, 
    You must <a href="log-in.php" class="main-color">Login</a> OR <a href="sing-up.php" class="main-color">Sign Up</a>
    then click on Logo
    </div>
    <?php } ?>
                ...
                <div class="product__item">
                    ...
                    ?>
                        ...
                        <ul class="product__hover">
                            ...
                            <li><a href="shop-cart.php?user_id=<?php echo $_SESSION["ID"] ?>"><span
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        ...
                        <div class="trend__item__text">
                            <h6><a href="product.php?id=<?php echo $product["id"] ?>&page=view"
                                    target="_blank"><?php echo $trend_product["name"] ?></a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        ...
                        <div class="trend__item__text">
                            <h6><a href="product.php?id=<?php echo $product["id"] ?>&page=view"
                                    target="_blank"><?php echo $seller_product["name"] ?> </a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        ...
                        <div class="trend__item__text">
                            <h6><a href="product.php?id=<?php echo $product["id"] ?>&page=view"
                                    target="_blank"><?php echo $featrue_product["name"] ?></a></h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
